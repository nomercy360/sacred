...
import {useParams, createAsync, RouteSectionProps, A} from '@solidjs/router';
import {getWishData} from './[id].data';
import {SEOHead} from '~/components/SEOHead';

export const route = {
    load: ({params}: RouteSectionProps) => getWishData(params.id)
};
...
export default function WishPage() {
    ...
    return (
        <>
            <Show when={wish() !== undefined && wish() !== null} fallback={
                <Show when={wish() === null} fallback={
                    ...
                    <div class="min-h-screen bg-white flex items-center justify-center">
                        <div class="text-center">
                            <h1 class="text-2xl font-bold text-gray-900 mb-4">Wish not found</h1>
                            <p class="text-gray-600 mb-6">This wish doesn't exist or has been removed.</p>
                            <A href="/"
                               class="bg-black text-white py-2 px-6 rounded-lg hover:bg-gray-900 transition-colors">
                                Go back home
                            </A>
                        </div>
                    </div>
