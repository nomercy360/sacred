        ...
        >
            <Show when={!hasError()}>
                <img
                    ...
                    class={`absolute left-0 top-0 h-full w-full object-cover transition-opacity duration-300 ease-in-out ${props.imageClass || ''}`}
                    classList={{
                        'opacity-0': !isLoaded(),
            ...
            <Show when={hasError()}>
                <div class="absolute left-0 top-0 flex h-full w-full items-center justify-center text-gray-500">
